...
{
  public class NonXorAnsi : LogicGate
  {
    ...
    public sealed override void Render(DrawingContext context)
    {
      ...
      context.DrawLine(
          ...
          new Avalonia.Point(startPointX - 1, startPointY + 3 * elipseRadious));
      ...
      using (StreamGeometryContext geometryContext = geometry.Open())
      {
        ...
        geometryContext.BeginFigure(new Point(startPointX, 0), false);
        geometryContext.CubicBezierTo(new Point(startPointX * 1.2, 0), new Point(startPointX * 1.2, startPointY * 2), new Point(startPointX, startPointY * 2));
        geometryContext.EndFigure(false);


        geometryContext.BeginFigure(new Point(startPointX - 10, 0), false);
        geometryContext.CubicBezierTo(new Point((startPointX - 10) * 1.2, 0), new Point((startPointX - 10) * 1.2, startPointY * 2), new Point(startPointX - 10, startPointY * 2));
        geometryContext.EndFigure(false);
